      ...
      <v-row justify="center">
        ...
        <v-col class="d-flex child-flex">
          <v-card>
            ...
            <v-img src="..\..\..\картинки\2.jpg" aspect-ratio="1"
                   class="grey lighten-2"></v-img>
...
export default {
  ...
  data: () => ({
    ...
    listTask: [
      ...
      { name: "Оливер Джонас", id: 6},
      { name: "Анастасия Антоновна", id: 7 },
      { name: "Максим Викторович", id: 8 },
      { name: "Платон Иванович", id: 9 },
      { name: "Агата Ивановна", id: 10 }
    ],
    listFirstAnswer: [],
    listSecondAnswer: [],
    listThirdAnswer: [],
